...
//   location: "Madagascar",
//   shortDescription:
//     "Développeur Full-Stack orienté produit, concevant des applications web et mobiles performantes, fiables et scalables.",
//   description:
//     "Je conçois  des solutions logicielles sur mesure : applications web et mobiles performantes, sécurisées et évolutives, avec un fort focus sur l’expérience utilisateur et la valeur business.",
//   highlights: [
//     "Conception et développement de solutions SaaS (B2B & B2C)",
//     "Applications web et mobiles cross-platform performantes",
//     "Architecture propre, modulaire et scalable",
//     "Focus sur la valeur business et l’expérience utilisateur",
