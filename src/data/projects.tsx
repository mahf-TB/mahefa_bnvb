...
export const projects = [
...

  {
    ...
    title: "Plateforme SaaS Éducative – ONIRTECH",
    description:
      "Application SaaS éducative développée dans un contexte professionnel, visant à améliorer l’apprentissage collaboratif et la gestion des contenus.",
    list: [
...

  {
    ...
    links: [
      ...
      { title: "Express.js", href: "https://expressjs.com" },
      { title: "MongoDB", href: "https://www.mongodb.com" },
      { title: "React Query", href: "https://tanstack.com/query" },
    ],
  },
...

  {
    ...
    title: "Sell2Door – SaaS de Livraison Géolocalisée",
    description:
...

  {
    ...
    links: [
      ...
      { title: "Laravel", href: "https://laravel.com" },
      { title: "MySQL", href: "https://www.mysql.com" },
      { title: "Merise", href: "https://fr.wikipedia.org/wiki/Merise" },
    ],
  },

  {
    ...
    description:
      "Conception UX/UI de deux plateformes SaaS majeures : une application mobile de livraison géolocalisée (Sell2Door) et une plateforme B2B de gestion commerciale (IntSales). Les designs sont orientés performance, clarté des parcours et expérience utilisateur optimale.",
    list: [
    ...
    links: [
      {
        title: "Sell2Door – Figma Design",
        href: "https://figma.com/file/SELL2DOOR_LINK",
      },
      {
        title: "IntSales – Figma Design",
        href: "https://figma.com/file/INTSALES_LINK",
      },
    ],
